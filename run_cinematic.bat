...
start "Hangeul Design Cinematic Server" /MIN cmd /c ""%CD%\venv\Scripts\python.exe" -m streamlit run "%CD%\app_cinematic.py" --server.address localhost --server.port %PORT% --server.headless true"
